...
class GamePanel extends JPanel implements ActionListener, KeyListener {
    ...
    static final int UNIT_SIZE = 25; // size of each grid unit
    static final int GAME_UNITS = (SCREEN_WIDTH * SCREEN_HEIGHT) / (UNIT_SIZE * UNIT_SIZE);
    static final int DELAY = 100; // timer delay in ms, controls speed
    ...
    public void gameOver(Graphics g) {
        ...
        String scoreText = "Score: " + applesEaten;
        g.drawString(scoreText, (SCREEN_WIDTH - metrics1.stringWidth(scoreText)) / 2, SCREEN_HEIGHT / 3);
        ...
        g.drawString(restartText, (SCREEN_WIDTH - metrics3.stringWidth(restartText)) / 2, SCREEN_HEIGHT / 2 + 75);
    }
